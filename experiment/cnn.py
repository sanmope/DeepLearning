...
if __name__ == "__main__":
    ...
    parser.add_argument("--random-buffer-size",
                        help="Size of random buffer of the MLP",
                        default=2048,
                        type=int)
    ...
    parser.add_argument("--batch-size",
                        help="Size of batch of the MLP",
                        default=128,
                        type=int)
    parser.add_argument("--lr",
                        help="Learning Rate of the MLP",
                        default=1e-3,
                        type=float)
    parser.add_argument("--weight-decay",
                        help="Weight Decay of the MLP",
                        default=1e-5,
                        type=float)
    ...
    mlflow.set_experiment(f"diplodatosCNN.{args.language}")

    with mlflow.start_run():
        logging.info("Starting experiment")
        # Log all relevent hyperparameters
        mlflow.log_params({
            "model_type": "Convulsional Network",
